...
// for the run — so the tier stays black-box (ADR-0010). Playing the agent and reading run status
// reuse the mechanics-tier steps; only the cluster-facing claims live here.
//
